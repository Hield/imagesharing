<div class="container">
	<?php if ($check) { ?>
		<h1>My images</h1>
		<a class="users-link" href="<?php echo link_to_user($username, 'favorites') ?>">My favorite images</a>
	<?php } else { ?>
		<h1><?php echo $username; ?>'s images</h1>
		<a class="users-link" href="<?php echo link_to_user($username, 'favorites') ?>"><?php echo $username; ?>'s favorite images</a>
	<?php } ?>
	...
	<?php } else { ?>
		...
		<?php } else { ?>
			<h2>This user hasn't uploaded any images yet!</h2>
		<?php } ?>
	<?php } ?>
</div>